...
| R-03 | Tool-prefix normalization regression causes false mismatch scoring | Medium | Low | Prefix handling tests exist across runtime/eval layers | Keep normalization tests as required quality gate |
