...
def test_jira_tool_target_helpers() -> None:
    ...
    assert jira_tool_target._extract_issue_key({"arguments": {"issue_key": "JRASERVER-1"}}, {"issue_key": "JRASERVER-1"}) == "JRASERVER-1"
    assert jira_tool_target._extract_issue_key({"params": {"arguments": {"issue_key": "JRASERVER-2"}}}, {"issue_key": "JRASERVER-2"}) == "JRASERVER-2"
    assert jira_tool_target._extract_issue_key({"arguments": '{"issue_key":"JRASERVER-3"}'}, {"issue_key": "JRASERVER-3"}) == "JRASERVER-3"
